...
pub const Uuid = struct {
    ...
    pub const namespace_dns: Uuid = parse("6ba7b810-9dad-11d1-80b4-00c04fd430c8") catch unreachable;
    pub const namespace_url: Uuid = parse("6ba7b811-9dad-11d1-80b4-00c04fd430c8") catch unreachable;
    pub const namespace_oid: Uuid = parse("6ba7b812-9dad-11d1-80b4-00c04fd430c8") catch unreachable;
    pub const namespace_x500: Uuid = parse("6ba7b814-9dad-11d1-80b4-00c04fd430c8") catch unreachable;
    ...
    pub fn getTimestampV1(self: Uuid) ?u60 {
    ...
    /// Returns 100-nanosecond intervals since 1582-10-15T00:00:00Z.
    pub fn getTimestampV6(self: Uuid) ?u60 {
    ...
    pub fn getTimestampV7(self: Uuid) ?u48 {
    ...
    pub fn getClockSeq(self: Uuid) ?u14 {
    ...
    pub fn assertValid(uuid: Uuid, expected_version: Version) void {
    ...
    pub fn v4WithSource(random: std.Random) Uuid {
    ...
    pub fn v5(namespace: Uuid, name: []const u8) Uuid {
        ...
        var uuid: Uuid = .{ .bytes = digest[0..16].* };
    ...
    pub fn v1FromFields(timestamp: u60, clock_seq: u14, node: [6]u8) Uuid {
        var uuid: Uuid = undefined;
    ...
    pub fn v6FromFields(timestamp: u60, clock_seq: u14, node: [6]u8) Uuid {
        var uuid: Uuid = undefined;
    ...
    pub fn v7FromFields(unix_ts_ms: u48, counter: u12, rand_b: [8]u8) Uuid {
        var uuid: Uuid = undefined;
